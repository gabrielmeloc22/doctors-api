...
it("should get bookings within the date range for given slot", async () => {
    const app = createApp();
    ...
    await createSlot({
        ...
        startTime: new Date("2024-12-21T08:00:00.000Z"),
        endTime: new Date("2024-12-21T08:30:00.000Z"),
    });
    ...
    await createSlot({
        ...
        startTime: new Date("2024-12-25T15:00:00.000Z"),
        endTime: new Date("2024-12-25T15:15:00.000Z"),
    });
    ...
    const response = await request(app.listen()).get(
        `/doctors/${doctor.id}/available_slots?start_time=2024-12-21T10:00:00.000Z&end_time=2024-12-25T10:00:00.000Z`
    );
